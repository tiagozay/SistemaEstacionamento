    ...
    template(model) {
        return `
            ...
            <div  class="linhaInputs">
                <label for="">
                    Placa veículo
                    <input type="text" class="padraoInputPlaca inputObrigatorio" name="placa" id="formCadastroTiket__inputPlaca" value="${model['placa'] ? model['placa'] : ""}">
                </label>
                <label for="">
                    Marca veículo
                    <input type="text" class="inputObrigatorio" name="marca" value="${model['marcaVeiculo'] ? model['marcaVeiculo'] : ""}">
                </label>
                <label for="">
                    Modelo veículo
                    <input type="text" class="inputObrigatorio" name="modelo" value="${model['modeloVeiculo'] ? model['modeloVeiculo'] : ""}">
                </label>
            </div>
            ...
            return categorias.map(categoria => `<option value=${categoria} ${categoria == categoriaVeiculo ? "selected" : ""}>${categoria}</option>`);
                ...
                <label for="">
                    Valor hora
                    <input type="text" name="valorHora" class="inputDesativado inputObrigatorio" readonly="true" value=${model['valorHora'] ? model['valorHora'] : ""}> 
                </label>
                <label for="">
                    Número vaga
