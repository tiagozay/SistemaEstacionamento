...
class Mensalidade
{
    ...
    static formataMensalidadesParaListar(mensalidades: Array<Mensalidade>): Array<object>
    {
...
export function listarMensalidades()
{
    ...
    const zayDataTable__mensalidades = new ZayDataTable(
        nomeTabela,
        $("#tabelaMensalidades") as HTMLTableElement,
        [
